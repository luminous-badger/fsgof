...
# as you cite:
# Fuzzy Set Goodness of Fit Tests Version 2.
# JM & WO 2016/06/28
...
# c:\python\python.exe CDsuff.py inputfile.csv Y-Value measurement_error_mean sigma_mem > outputfile.txt
# where Y-Value is from 1 to 4. Eg
# c:\python\python.exe CDsuff.py indiafile.csv 3 0.01 0.05 > outputfile.txt
# Mac or Linux Terminal:
# CDsuff.py inputfile.csv Y-Value measurement_error_mean sigma_mem > outputfile.txt
...
def calc_nullsd1( measurement_error_mean, sigma_mem ):
	nullsd = measurement_error_mean**2 + sigma_mem**2
	return nullsd
...
print 'Using:'
print 'File Name - input:', fname
print 'Y Value:', Yval
print 'Measurement Error Mean:', measurement_error_mean
print 'Sigma:', sigma_mem
...
print '{:>2s}'.format( 'Y' ),
print '{:<8s}'.format( 'Csuff' ),
print '{:<11s}'.format( 'Dsuff' ),
print '{:<10s}'.format( 'F1 Numer' ),
print '{:<10s}'.format( 'F1 Denom' ),
print '{:<10s}'.format( 'F1' ),
print '{:<8s}'.format( 'PVAL1' ),
print '{:<15s}'.format( 'F2' ),
print '{:<8s}'.format( 'PVAL2' ),
print '{:<3s}'.format( 'Num' ),
print
'''

print '    Config  Y Csuff    Dsuff    F1NumerSSD  F1DenomEMSD   F1        PVAL1      F2     PVAL2 Num'

opcsv.writerow( [ 'Config', 'Y', 'Csuff', 'Dsuff', 'F1NumerSSD', 'F1DenomEMSD', 'F1', 'PVAL1', 'F2', 'PVAL2', 'Num' ] )
